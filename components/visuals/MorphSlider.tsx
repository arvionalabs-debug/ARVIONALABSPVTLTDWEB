...
class MorphEngine {
  ...
  constructor(
    ...
    this.program = new Program(this.gl, {
      ...
      uniforms: {
        ...
        uProgress: { value: 0 },
        uDir: { value: 1 },
        uMode: { value: (TRANSITIONS as any)[opts.transition] ?? 0 },
  ...
  syncOptions() {
    const opts = this.getOptions();
    this.program.uniforms.uMode.value = (TRANSITIONS as any)[opts.transition] ?? 0;
  ...
  return (
    ...
    >
      <div
        ...
        aria-label="Edu Tour Image Morph Slider"
        tabIndex={0}
        onKeyDown={onKeyDown}
      />
